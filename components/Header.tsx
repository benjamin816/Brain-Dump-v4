...
const Header = () => {
  return (
    <header className="bg-gray-800/50 backdrop-blur-sm border-b border-gray-700 fixed top-0 left-0 right-0 z-10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            ...
            <span className="ml-3 text-2xl font-bold text-white">Braindump</span>
          </div>
          <div className="flex items-center">
            ...
            <div className="ml-4 h-8 w-8 rounded-full bg-gray-600 flex items-center justify-center font-bold">
              U
            </div>
          </div>
        </div>
